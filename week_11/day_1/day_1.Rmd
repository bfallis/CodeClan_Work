...
```{r}
dummy_cols(diamonds_trim, select_columns = "cut", remove_first_dummy = TRUE)
dummy_cols(diamonds_trim, select_columns = "clarity", remove_first_dummy = TRUE)
dummy_cols(diamonds_trim, select_columns = "color", remove_first_dummy = TRUE)
```
...
# clarity appears to be the best.
```
